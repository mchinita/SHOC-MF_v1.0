...
! Broadcast namelist variables
  ...
  !------------------------------------------------------------------- !
    ...
    call addfld('PBL_WTHL', horiz_only, 'A', 'm', 'PBL as the first level where wthl = wthl_surf*0.01')
    call addfld('PBL_TKE', horiz_only, 'A', 'm', 'PBL as the first level where TKE vanishes')
